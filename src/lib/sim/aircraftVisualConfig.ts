...
const TANKER_ATTACHMENT_CONFIGS: Record<AircraftAssetSet, TankerAttachmentConfig> = {
  legacy: {
    ...
    boomFairing: {
      shroudPosition: { x: 0, y: -0.18, z: 7.16 },
      shroudRotation: { x: 0.16, y: 0, z: 0 },
      shroudScale: { x: 1.08, y: 0.3, z: 1.78 },
      bracePosition: { x: 0, y: -0.54, z: 7.48 },
      braceRotation: { x: 0.78, y: 0, z: 0 },
      braceScale: { x: 0.14, y: 0.96, z: 0.18 },
      collarPosition: { x: 0, y: -0.87, z: 7.72 },
      collarRotation: { x: Math.PI / 2, y: 0, z: 0 },
      collarRadiusTop: 0.18,
      collarRadiusBottom: 0.28,
      collarLength: 0.58,
    },
  },
  realistic: {
